...
class StepIcon extends Component {
  ...
  renderImage = (stepNum) => {
    // tintColor: this.props.stepNum !== 1 && this.props.isActiveStep ? 'white' : null
    switch (stepNum) {
      case 1:
      ...
      case 4:
        return <Image source={require('../../assets/infor.png')} style={{ width: 20, height: 20, tintColor: this.props.isActiveStep ? 'white' : null }} resizeMode="contain" />
      default:
        break;
    }
  }
        ...
        <View style={styles.circleStyle}>
          <Text style={styles.circleText}>
            {this.props.isCompletedStep ? (
              ...
              <View>
                {this.renderImage(this.props.stepNum)}
              </View>
            )}
          </Text>
        </View>
